...
export const userNames = (el) => {
  ...
  `
    ...
    const organizations = `<div class="border-top padding-t-16 margin-t-16  hide-lg">
  ...
  elements.userBio.insertAdjacentHTML("afterbegin", bio);
    ...
    elements.organizations.insertAdjacentHTML("afterbegin", organizations);
};
