...
// ============= Function to display "User" dropdown
const dropdownYour = () => {
...
// ============= Function to display "Type: All" dropdown
const dropdownType = () => {
...
// ============= Function to display "Language: All" dropdown
const dropdownRepo = () => {
...
// ============= Function to display "Set Status"
...
// ============= Function to display "Set Status" (mini)
const dropdownStatusMini = () => {
  document.getElementById("details-dial-mini").classList.toggle("show-flex");
  document.getElementById("overlay-6").classList.toggle("show-block");
};
